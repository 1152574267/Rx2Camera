...
import com.mrk.rx2camera.callback.SurfaceCallback;
import com.mrk.rx2camera.config.RxCameraConfig;
import com.mrk.rx2camera.exception.BindSurfaceFailedException;
import com.mrk.rx2camera.exception.OpenCameraException;
import com.mrk.rx2camera.exception.OpenCameraFailedReason;
import com.mrk.rx2camera.exception.StartPreviewFailedException;
...
public class RxCameraInternal implements SurfaceCallback.SurfaceListener, Camera.PreviewCallback {
    private static final String TAG = RxCameraInternal.class.getSimpleName();
